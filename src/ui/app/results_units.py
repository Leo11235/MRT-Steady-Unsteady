...
EXPLICIT_FIELDS: dict[str, tuple[str, Optional[str], str]] = {
    ...
    "augmented_regression_rate_exponent":  ("Augmented regression exponent (N)", None, "."),
    ...
    "average_fuel_mass_flow_rate":         ("Avg fuel mass flow rate",   "mass_flow","kg/s"),
    ...
    "chamber_gas_molar_weight":            ("Chamber gas molar weight",  None,      "kg/mol"),
    "heat_capacity_ratio":                 ("Heat capacity ratio (γ)",   None,      "."),
    ...
    "regression_rate_scaling_coefficient":
                                    ("Regression coefficient (a)", None,        "."),
    "regression_rate_exponent":    ("Regression exponent (n)",     None,        "."),
    ...
    "injector_discharge_coefficient": ("Injector discharge coeff (Cd)", None, "."),
